# Prácticas — DataControl (DataFlex)
...
- **Guía MySQL** ([`README.md`](DataControl/README.md)): creación de usuarios con acceso exclusivo a una base de datos, gestión de privilegios (`GRANT`), verificación y resolución de errores comunes.
- **Conexión DataFlex** ([`DataflexConexión.md`](DataControl/DataflexConexión.md)): notas sobre la conexión de DataFlex a la base de datos.
- **`LigaBotonesSumar.wo`**: web object de DataFlex desarrollado como ejercicio.
